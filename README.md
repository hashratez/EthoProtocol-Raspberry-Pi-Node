...
###### Step 4 
Edit the autogenerated script as outlined below for the correct Geth Binaries. The install script from the EthoProtocol Node Dashboard will look something like this:
